\begin{filecontents}[force]{\jobname.xmpdata}
    ...
    \Volume{1}
    \Identifier{urn:uuid:7355ED09-3DEE-4870-866A-0C768ED5AA18}
    \Producer{XeLaTeX}
    \Creator{XeLaTeX}
\end{filecontents}
...
A polyglot programmer proficient in 10+ languages, lately focused on .NET, Python, and Go.
...
\cvRightSection{Skills}
    \cvSkill{Go\hspace{5pt}\textcolor{secondaryTextColor}{(5 years)}}{5}
    \cvSkill{C\# / .NET}{5}
